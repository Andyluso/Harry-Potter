...
function filterAndUpdateCarousel() {
    ...
    let filteredCharacters = ravenclawCharacters.filter(character => {
        const isFavorite = favoritosCheckbox ? favoritosCheckbox.checked : false;
...
function fetchAndDisplayCharacters() {
    fetch('https://hp-api.onrender.com/api/characters')
        ...
        .then(data => {
            ravenclawCharacters = data.filter(character => character.house === 'Ravenclaw');
